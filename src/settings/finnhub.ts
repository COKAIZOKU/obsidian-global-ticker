    ...
    items: [
        {
            ...
            control: {type: "toggle", key: "showFinnhubTicker"},
        },
        {
        ...
        },
        {
            ...
            control: {type: "textarea", key: "finnhubSymbols", placeholder: "Aapl, msft, tsla"},
        },
        {
            name: "Stocks positive change color",
            desc: "Select any color.",
            control: {type: "color", key: "finnhubChangeColor", defaultValue: "#a68af6"},
        },
        {
            name: "Stocks negative change color",
            desc: "Select any color.",
            control: {type: "color", key: "finnhubChangeNegativeColor", defaultValue: "#fb464c"},
        },
        {
        ...
        },
        {
            ...
            control: {type: "toggle", key: "showFinnhubFooter"},
        },
        {
